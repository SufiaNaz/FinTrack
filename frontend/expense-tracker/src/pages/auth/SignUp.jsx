        ...
        <div className="signup-container">
            <div className="signup-card">
                ...
                <div className="form-area">
                    ...
                    <form className="form" onSubmit={handleSubmit} aria-label="signup form">
                        <ul className="wrapper" role="list">
                            <li style={{ "--i": 5 }}>
                                ...
                                <input className="input" type="text" placeholder="Full Name" name="name" required aria-label="Full Name" />
                            </li>
                            ...
                            <li style={{ "--i": 4 }}>
                                ...
                                <input className="input" type="tel" placeholder="Phone Number" name="phone" required aria-label="Phone Number" />
                            </li>
