...
const SignUp = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (phone.length < 10) return alert("Phone number must be only 10 numbers");
  ...
  <li style={{ "--i": 4 }}>
    ...
    <input className="input" type="text" placeholder="Phone Number" name="phone" required aria-label="Phone Number" />
  </li>
